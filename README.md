...
A REST API example built with [Echo](https://echo.labstack.com/) — a high performance, minimalist Go web framework.
...
```bash
git clone https://github.com/GetWebstack-public/go-echo
cd go-echo
```
